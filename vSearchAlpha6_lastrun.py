...
expName = 'vSearchAlpha6'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\v-search-alpha6\\vSearchAlpha6_lastrun.py',
